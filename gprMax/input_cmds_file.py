...
def check_cmd_names(processedlines, checkessential=True):
    ...
    singlecmds = dict.fromkeys(['#domain', '#dx_dy_dz', '#time_window', '#title', '#messages', '#num_threads', '#time_step_stability_factor', '#pml_formulation', '#pml_cells', '#excitation_file', '#taguchi', '#end_taguchi', '#output_dir',
                                ], None)
